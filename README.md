[![Build Status](https://dev.azure.com/ganeshmoff/ContosoAir/_apis/build/status/Ganesamurthy.ContosoAir?branchName=master)](https://dev.azure.com/ganeshmoff/ContosoAir/_build/latest?definitionId=5&branchName=master)
